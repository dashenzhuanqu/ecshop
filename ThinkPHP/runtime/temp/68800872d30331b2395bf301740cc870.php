      ...
      <ul class="menu" id="menu-ul">
          ...
          商品管理                    <div class="submenu">
            ...
            <ul>
                          ...
                          <li key="03_promotion" class="icon-promotion" data-url="bonus.php?act=list" data-key="04_bonustype_list" name="menu" onclick="showsub(this)">
          促销管理                    <div class="submenu">
            <div class="title">促销管理</div>
            <ul>
                          <li id="sub-menu-04_bonustype_list" class="menu-item" onclick="showact(this, event)"><a href="bonus.php?act=list" target="main-frame">红包类型</a></li>
          ...
          广告管理                    <div class="submenu">
            ...
            <ul>
                          <li id="sub-menu-ad_list" class="menu-item" onclick="showact(this, event)"><a href="ads/ads/ads_list" target="main-frame">广告列表</a></li>
