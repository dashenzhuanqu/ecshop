<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:97:"C:\Users\Shinelon\Desktop\ecshop\ThinkPHP\public/../application/index\view\goods\goods_trash.html";i:1536897401;}*/ ?>
...
<div class="form-div">
  <form action="<?php echo url('goods_trash'); ?>" method="post">
        <!-- 关键字 -->
...
<table cellpadding="3" cellspacing="1">
  ...
  <tr>
    ...
    <td><?php echo $v['goods_art']; ?></td>
    <td><?php echo $v['goods_price']; ?></td>
    <td><a href="javascript:;" class="is_delete" id="<?php echo $v['g_id']; ?>" value="<?php echo $v['is_delete']; ?>" >还原</a> |
    <a href="<?php echo url('goods/goods_del'); ?>?id=<?php echo $v['g_id']; ?>">移除</a></td>
  </tr>
  <?php endforeach; ?>
...
<table id="page-table" cellspacing="0">
  <tr>
    <td>
      ...
      <select name="target_cat" style="display:none" onchange="checkIsLeaf(this)"><option value="0">请选择...</caption><option value="1" >饮料</option><option value="2" >&nbsp;&nbsp;&nbsp;&nbsp;学习</option></select>
...
<!--</script>-->
<div id="footer">
共执行 8 个查询，用时 0.018004 秒，Gzip 已禁用，内存占用 2.070 MB<br />
