<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:96:"C:\Users\Shinelon\Desktop\ecshop\ThinkPHP\public/../application/index\view\goods\brand_edit.html";i:1536319257;}*/ ?>
﻿<!-- $Id: brand_info.htm 14216 2008-03-10 02:27:21Z testyang $ -->
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
  <base href="/">
<title>ECSHOP 管理中心 - 编辑品牌记录 </title>
...
<!--遮罩-->
<h1>
      <a class="btn btn-right" href="<?php echo url('goods/brand_list'); ?>">商品品牌</a>
  
    <span class="action-span1"><a href="index.php?act=main">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1">&nbsp;&nbsp;>&nbsp;&nbsp;编辑品牌记录 </span>
  <div style="clear:both"></div>
</h1><div class="main-div">
<form method="post" action="<?php echo url('goods/brand_upd'); ?>" name="theForm" enctype="multipart/form-data" onsubmit="return validate()">
<table cellspacing="1" cellpadding="3" width="100%">
  <tr>
    <td class="label">品牌名称</td>
    <td><input type="text" name="brand_name" maxlength="60" value="<?php echo $arr['brand_name']; ?>" /><span class="require-field">*</span></td>
  </tr>
  <tr>
    <td class="label">品牌网址</td>
    <td><input type="text" name="brand_url" maxlength="60" size="40" value="<?php echo $arr['brand_url']; ?>" /></td>
  </tr>
  <tr>
    ...
    <td><input type="file" name="brand_img" value="<?php echo $arr['brand_img']; ?>" id="logo" size="45">    <br /><span class="notice-span" style="display:block"  id="warn_brandlogo">
        请上传图片，做为品牌的LOGO！        </span>
    </td>
  </tr>
  <tr>
    <td class="label">品牌描述</td>
    <td><textarea  name="brand_desc" value="<?php echo $arr['brand_desc']; ?>" cols="60" rows="4"  ></textarea></td>
  </tr>
  <tr>
    <td class="label">排序</td>
    <td><input type="text" name="sort_order" maxlength="40" size="15" value="<?php echo $arr['sort_order']; ?>" /></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="2" align="center"><br />
      ...
      <!--<input type="hidden" name="old_brandname" value="可口可乐" />-->
...
<div id="footer">
共执行 3 个查询，用时 0.023504 秒，Gzip 已禁用，内存占用 1.406 MB<br />
