      ...
      <form enctype="multipart/form-data" action="" method="post" name="theForm" >
        ...
        <table width="90%" id="general-table" align="center" class="gk-table">
          ...
          <tr>
            ...
            <td><select name="cat_id" onchange="hideCatDiv()"><option value="0">请选择...</option><option value="1" >饮料</option><option value="2" >&nbsp;&nbsp;&nbsp;&nbsp;学习</option></select>
          ...
          <tr>
            ...
            <td><select name="brand_id" onchange="hideBrandDiv()" ><option value="0">请选择...<option value="1">可口可乐</option><option value="2">文档</option></select>
          ...
          <tr id="promote_4">
            ...
            <td id="promote_6" class="cal-group">
              <input name="promote_start_date" type="datetime-local" id="promote_start_date" size="12" ><img src="../../../static/picture/cal.png" alt=""></button> - <input name="promote_end_date" type="datetime-local" id="promote_end_date" size="12"/><img src="../../../static/picture/cal.png" alt=""></button>
            </td>
          </tr>
          <tr>
