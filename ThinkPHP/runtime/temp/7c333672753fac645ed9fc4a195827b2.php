<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"C:\Users\Shinelon\Desktop\ecshop\ThinkPHP\public/../application/index\view\add\add_add.html";i:1536311990;}*/ ?>
...
<!--遮罩-->
<h1>
    <a class="btn btn-right" href="/index/add/add">广告列表</a>

    <span class="action-span1"><a href="index.php?act=main">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1">&nbsp;&nbsp;&gt;&nbsp;&nbsp;添加广告 </span>
    <div style="clear:both"></div>
</h1><script type="text/javascript" src=""></script>
<link href="../../../static/css/calendar.css" rel="stylesheet" type="text/css">
<div class="main-div">
    <form action="/index/add/Ad_insert" method="post" name="theForm" enctype="multipart/form-data" onsubmit="return validate()">
        <table width="100%" id="general-table">
            ...
            <tr>
                ...
                <td>
                    <select name="ad_type" onchange="showMedia(this.value)">
            ...
            <tr>
                ...
                <td>
                    <input name="statr_time" type="datetime-local" id="start_time" size="22" value="2018-09-06">
                </td>
            </tr>
            <tr>
                <td class="label">结束日期</td>
                <td>
                    <input name="end_time" type="datetime-local" id="end_time" size="22" value="2018-10-06">
                </td>
            </tr>
            </tbody><tbody id="0">
        <tr>
        ...
        <tr>
            ...
            <tr>
                <td class="label">
                    <a href="javascript:showNotice('AdCodeFlash');" title="点击此处查看提示信息">
                        <img src="../../../static/picture/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>上传Flash文件</td>
                <td>
            ...
            <tbody><tr>
                ...
                <td>
                    <input type="radio" name="is_new" value="1" checked="true">开启        <input type="radio" name="is_new" value="0">关闭      </td>
            </tr>
            <tr>
                <td class="label">广告联系人</td>
                <td>
                    <input type="text" name="ad_man" value="" size="35">
                </td>
            </tr>
            <tr>
                <td class="label">联系人Email</td>
                <td>
                    <input type="text" name="ad_email" value="" size="35">
                </td>
            </tr>
            <tr>
                <td class="label">联系电话</td>
                <td>
                    <input type="text" name="ad_phone" value="" size="35">
                </td>
            </tr>
            <tr>
                <td class="label">&nbsp;</td>
...
<div id="footer">
    共执行 4 个查询，用时 0.117007 秒，Gzip 已禁用，内存占用 1.459 MB<br>
