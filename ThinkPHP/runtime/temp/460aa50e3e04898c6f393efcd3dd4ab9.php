<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:101:"C:\Users\Shinelon\Desktop\ecshop\ThinkPHP\public/../application/index\view\goods\goods_type_edit.html";i:1536307793;}*/ ?>
...
<head>
  <base href="/">
<title>ECSHOP 管理中心 - 编辑商品类型 </title>
...
<!--遮罩-->
<h1>
      <a class="btn btn-right" href="goods_type.php?act=manage">商品类型列表</a>
  
    <span class="action-span1"><a href="index.php?act=main">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1">&nbsp;&nbsp;>&nbsp;&nbsp;编辑商品类型 </span>
  ...
  <form action="" method="post" name="theForm" onsubmit="return validate();">
    <table cellspacing="1" cellpadding="3" width="100%">
      <tr>
        ...
        <td><input type="text" name="cat_name" value="书" size="40" />
...
<div id="footer">
共执行 3 个查询，用时 0.010490 秒，Gzip 已禁用，内存占用 1.332 MB<br />
