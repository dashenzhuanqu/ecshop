<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:98:"C:\Users\Shinelon\Desktop\ecshop\ThinkPHP\public/../application/index\view\goods\category_add.html";i:1536152275;}*/ ?>
      ...
      <tr>
        ...
        <td>
          <select name="parent_id">
            ...
            <option value="1" >饮料</option><option value="2" >&nbsp;&nbsp;&nbsp;&nbsp;学习</option>          </select>
        </td>
      </tr>
          ...
          var sel_filter_attr = "请选择筛选属性";
                      arr[1] = new Array();
                                          ...
                                          arr[4][0] = ["价格等级", 81];
                                                        ...
                                                        arr[4][6] = ["宽度", 65];
                                                        arr[4][7] = ["红外/蓝牙", 80];
                                                        arr[4][8] = ["副屏参数/外屏参数", 61];
                                                        arr[4][9] = ["随机配件", 76];
                                                        arr[4][10] = ["支持频率/网络频率", 57];
                                                        arr[4][11] = ["标准配置", 72];
                                                        arr[4][12] = ["内存容量", 68];
                                                        arr[4][13] = ["长度", 64];
                                                        arr[4][14] = ["彩信/彩e", 79];
                                                        arr[4][15] = ["主屏参数/内屏参数", 60];
                                                        arr[4][16] = ["天线位置", 75];
                                                        arr[4][17] = ["网络制式", 56];
                                                        arr[4][18] = ["待机时间", 71];
                                                        arr[4][19] = ["屏幕材质", 67];
