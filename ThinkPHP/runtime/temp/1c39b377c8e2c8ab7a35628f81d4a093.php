<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:99:"C:\Users\Shinelon\Desktop\ecshop\ThinkPHP\public/../application/index\view\goods\category_move.html";i:1536306194;}*/ ?>
  ...
  <tr>
    <td colspan="2" align="center">
      ...
      <select name="cat_id">
       ...
       <option value="1" >饮料</option><option value="2" selected='ture'>&nbsp;&nbsp;&nbsp;&nbsp;学习</option><option value="3" >笔记本</option><option value="4" >&nbsp;&nbsp;&nbsp;&nbsp;学习</option>      </select>&nbsp;&nbsp;
      <strong>转移到</strong>
