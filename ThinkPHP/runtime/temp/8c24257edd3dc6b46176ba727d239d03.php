<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:96:"C:\Users\Shinelon\Desktop\ecshop\ThinkPHP\public/../application/index\view\goods\goods_list.html";i:1536324648;}*/ ?>
...
<div class="form-div">
  <form action="javascript:searchGoods()" name="searchForm">
        <!-- 分类 -->
    商品分类
    <select name="cat_id"><option value="0">所有分类</option><option value="1" >饮料</option><option value="2" >&nbsp;&nbsp;&nbsp;&nbsp;学习</option></select>
    <!-- 品牌 -->
    品牌
    <select name="brand_id"><option value="0">所有品牌</option><option value="1">可口可乐</option><option value="2">文档</option></select>
    <!-- 推荐 -->
    推荐类别
...
<table cellpadding="3" cellspacing="1">
  ...
  <?php foreach ($arr as $k=>$v){?>
    ...
    <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 1)"><?php echo $v['goods_name']; ?></span></td>
    ...
    <td align="center">
      ...
      <a href="javascript:;" onclick="listTable.remove(1, '您确实要把该商品放入回收站吗？')" title="回收站">回收站</a>
