<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"C:\Users\Shinelon\Desktop\ecshop\ThinkPHP\public/../application/index\view\money\success.html";i:1536287618;}*/ ?>
    ...
    <div style="background:#FFF; padding: 20px 50px; margin: 2px;">
        <table align="center" width="400">
            <tbody><tr>
                ...
                <td style="font-size: 14px; font-weight: bold">添加&nbsp;1&nbsp;操作成功!</td>
            </tr>
            <tr>
                <td></td>
            ...
            <tr>
                ...
                <td>
                    <ul style="margin:0; padding:0 10px" class="msg-link">
                        <li><a href="/index/money/money_add">继续添加红包类型</a></li>
                        <li><a href="/index/money/money">返回红包类型列表</a></li>
                    </ul>
...
<script language="JavaScript">
    <!--
    var seconds = 3;
    var defaultUrl = "bonus.php?act=add";
...
<div id="footer">
    共执行 5 个查询，用时 0.073004 秒，Gzip 已禁用，内存占用 1.445 MB<br>
