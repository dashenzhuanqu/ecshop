<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:100:"C:\Users\Shinelon\Desktop\ecshop\ThinkPHP\public/../application/index\view\goods\attribute_list.html";i:1536918199;}*/ ?>
...
<!--遮罩-->
<h1>
      <a class="btn btn-right" href="<?php echo url('addattr'); ?>">添加属性</a>
...
<div class="list-div" id="listDiv">
  ...
  <table cellpadding="3" cellspacing="1">
    ...
    <?php if(is_array($arr) || $arr instanceof \think\Collection || $arr instanceof \think\Paginator): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
      ...
      <td align="right" nowrap="true" valign="top"><span onclick="listTable.edit(this, 'edit_sort_order', 1)"><?php echo $v['sort']; ?></span></td>
      <td align="center" nowrap="true" valign="top">
        <a href="<?php echo url('goods/attribute_edit'); ?>?id=<?php echo $v['attr_id']; ?>">编辑</a>
        <a href="<?php echo url('goods/attribute_del'); ?>?id=<?php echo $v['attr_id']; ?>" title="移除">移除</a>
      </td>
    </tr>
    <?php endforeach; endif; else: echo "" ;endif; ?>
      </table>
...
<script>
  $(document).on('change','.type',function(){
     ...
     if(id==0){
         ...
         window.location.href='<?php echo url("goods/attribute_lists"); ?>?id='+id+'';
     }
  })
</script>