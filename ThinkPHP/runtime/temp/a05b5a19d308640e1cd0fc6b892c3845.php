<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:98:"C:\Users\Shinelon\Desktop\ecshop\ThinkPHP\public/../application/index\view\system\system_list.html";i:1536659604;}*/ ?>
...
<h1>
  ...
  <div id="tabbar-div">
    <p>
      <span class="tab-front" id="shop_info-tab">网店信息</span>
      <span class="tab-back" id="basic-tab">基本设置</span>
      <span class="tab-back" id="display-tab">显示设置</span>
      <span class="tab-back" id="shopping_flow-tab">购物流程</span>
      <span class="tab-back" id="goods-tab">商品显示设置</span>
      <span class="tab-back" id="sms-tab">短信设置</span>
      </p>
  </div>
  <!-- tab body -->
  <div id="tabbody-div">
    <form enctype="multipart/form-data" name="theForm" action="?act=post" method="post">
        <table width="90%" id="shop_info-table" class="gk-table" >
                  <tr>
      ...
      <script>
        function actHover(item){
          var pop = item.nextElementSibling;
          pop.style.display = 'block';
        }
        function actLeave(item){
          var pop = item.nextElementSibling;
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_116_0"><input type="radio" name="value[116]" id="value_116_0" value="0"
            checked="true"                                                          />否</label>
                    <label for="value_116_1"><input type="radio" name="value[116]" id="value_116_1" value="1"
                                                                      />是</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_119_0"><input type="radio" name="value[119]" id="value_119_0" value="0"
                                                                      />否</label>
                    <label for="value_119_1"><input type="radio" name="value[119]" id="value_119_1" value="1"
      ...
      <script>
        ...
        <td class="panel-par">
                    <textarea name="value[121]" cols="40" rows="5"></textarea>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_122_0"><input type="radio" name="value[122]" id="value_122_0" value="1"
                                                                      />是</label>
                    <label for="value_122_1"><input type="radio" name="value[122]" id="value_122_1" value="0"
            checked="true"                                                          />否</label>
      ...
      <script>
        ...
        <table width="90%" id="basic-table" class="gk-table" style="display:none">
                  <tr>
        <td class="label" valign="top">
                    系统语言:
        </td>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_205_0"><input type="radio" name="value[205]" id="value_205_0" value="0"
                                                                      />无</label>
                    <label for="value_205_1"><input type="radio" name="value[205]" id="value_205_1" value="1"
            checked="true"                                                          />左上</label>
                    <label for="value_205_2"><input type="radio" name="value[205]" id="value_205_2" value="2"
                                                                      />右上</label>
                    <label for="value_205_3"><input type="radio" name="value[205]" id="value_205_3" value="3"
                                                                      />居中</label>
                    <label for="value_205_4"><input type="radio" name="value[205]" id="value_205_4" value="4"
                                                                      />左下</label>
                    <label for="value_205_5"><input type="radio" name="value[205]" id="value_205_5" value="5"
                                                                      />右下</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_207_0"><input type="radio" name="value[207]" id="value_207_0" value="1"
            checked="true"                                                          />是</label>
                    <label for="value_207_1"><input type="radio" name="value[207]" id="value_207_1" value="0"
                                                                      />否</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_209_0"><input type="radio" name="value[209]" id="value_209_0" value="0"
            checked="true"                          onclick="return ReWriterConfirm(this);"
                                                          />禁用</label>
                    <label for="value_209_1"><input type="radio" name="value[209]" id="value_209_1" value="1"
                                      onclick="return ReWriterConfirm(this);"
                                                          />简单重写</label>
                    <label for="value_209_2"><input type="radio" name="value[209]" id="value_209_2" value="2"
                                      onclick="return ReWriterConfirm(this);"
                                                          />复杂重写</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_214_0"><input type="radio" name="value[214]" id="value_214_0" value="0"
                                                                      />不需要审核</label>
                    <label for="value_214_1"><input type="radio" name="value[214]" id="value_214_1" value="1"
            checked="true"                                                          />需要审核</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_221_0"><input type="radio" name="value[221]" id="value_221_0" value="0"
            checked="true"                                                          />禁用</label>
                    <label for="value_221_1"><input type="radio" name="value[221]" id="value_221_1" value="1"
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_222_0"><input type="radio" name="value[222]" id="value_222_0" value="0"
            checked="true"                                                          />所有</label>
                    <label for="value_222_1"><input type="radio" name="value[222]" id="value_222_1" value="1"
                                                                      />一年</label>
                    <label for="value_222_2"><input type="radio" name="value[222]" id="value_222_2" value="2"
                                                                      />半年</label>
                    <label for="value_222_3"><input type="radio" name="value[222]" id="value_222_3" value="3"
                                                                      />三个月</label>
                    <label for="value_222_4"><input type="radio" name="value[222]" id="value_222_4" value="4"
                                                                      />一个月</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_226_0"><input type="radio" name="value[226]" id="value_226_0" value="0"
            checked="true"                                                          />否</label>
                    <label for="value_226_1"><input type="radio" name="value[226]" id="value_226_1" value="1"
                                                                      />是</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_227_0"><input type="radio" name="value[227]" id="value_227_0" value="0"
            checked="true"                                                          />所有用户</label>
                    <label for="value_227_1"><input type="radio" name="value[227]" id="value_227_1" value="1"
                                                                      />仅登录用户</label>
                    <label for="value_227_2"><input type="radio" name="value[227]" id="value_227_2" value="2"
                                                                      />有过一次以上购买行为用户</label>
                    <label for="value_227_3"><input type="radio" name="value[227]" id="value_227_3" value="3"
                                                                      />仅购买过该商品用户</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_228_0"><input type="radio" name="value[228]" id="value_228_0" value="0"
                                                                      />否</label>
                    <label for="value_228_1"><input type="radio" name="value[228]" id="value_228_1" value="1"
            checked="true"                                                          />是</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_231_0"><input type="radio" name="value[231]" id="value_231_0" value="on"
            checked="true"                                                          />开启</label>
                    <label for="value_231_1"><input type="radio" name="value[231]" id="value_231_1" value="off"
                                                                      />关闭</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_232_0"><input type="radio" name="value[232]" id="value_232_0" value="on"
                                                                      />开启</label>
                    <label for="value_232_1"><input type="radio" name="value[232]" id="value_232_1" value="off"
            checked="true"                                                          />关闭</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_233_0"><input type="radio" name="value[233]" id="value_233_0" value="1"
            checked="true"                                                          />是</label>
                    <label for="value_233_1"><input type="radio" name="value[233]" id="value_233_1" value="0"
                                                                      />否</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_234_0"><input type="radio" name="value[234]" id="value_234_0" value="1"
            checked="true"                                                          />是</label>
                    <label for="value_234_1"><input type="radio" name="value[234]" id="value_234_1" value="0"
                                                                          onclick="return confirm('如果您不保留商品原图，在“图片批量处理”的时候，\n将不会重新生成不包含原图的商品图片。请慎重使用该功能！');"
                      />否</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_235_0"><input type="radio" name="value[235]" id="value_235_0" value="1"
            checked="true"                                                          />开启</label>
                    <label for="value_235_1"><input type="radio" name="value[235]" id="value_235_1" value="0"
                                                                      />关闭</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_236_0"><input type="radio" name="value[236]" id="value_236_0" value="1"
            checked="true"                                                          />开启</label>
                    <label for="value_236_1"><input type="radio" name="value[236]" id="value_236_1" value="0"
                                                                      />关闭</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_242_0"><input type="radio" name="value[242]" id="value_242_0" value="1"
                                                                      />开启</label>
                    <label for="value_242_1"><input type="radio" name="value[242]" id="value_242_1" value="0"
            checked="true"                                                          />关闭</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_247_0"><input type="radio" name="value[247]" id="value_247_0" value="1"
                                                                      />需要开启</label>
                    <label for="value_247_1"><input type="radio" name="value[247]" id="value_247_1" value="0"
            checked="true"                                                          />不需要开启</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_903_0"><input type="radio" name="value[903]" id="value_903_0" value="1"
            checked="true"                                                          />需要审核</label>
                    <label for="value_903_1"><input type="radio" name="value[903]" id="value_903_1" value="0"
                                                                      />不需要审核</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_318_0"><input type="radio" name="value[318]" id="value_318_0" value="0"
                                                                      />不处理</label>
                    <label for="value_318_1"><input type="radio" name="value[318]" id="value_318_1" value="1"
                                                                      />保留不为 0 的尾数</label>
                    <label for="value_318_2"><input type="radio" name="value[318]" id="value_318_2" value="2"
                                                                      />不四舍五入，保留一位小数</label>
                    <label for="value_318_3"><input type="radio" name="value[318]" id="value_318_3" value="3"
                                                                      />不四舍五入，不保留小数</label>
                    <label for="value_318_4"><input type="radio" name="value[318]" id="value_318_4" value="4"
                                                                      />先四舍五入，保留一位小数</label>
                    <label for="value_318_5"><input type="radio" name="value[318]" id="value_318_5" value="5"
            checked="true"                                                          />先四舍五入，不保留小数 </label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_320_0"><input type="radio" name="value[320]" id="value_320_0" value="0"
            checked="true"                                                          />按上架时间</label>
                    <label for="value_320_1"><input type="radio" name="value[320]" id="value_320_1" value="1"
                                                                      />按商品价格</label>
                    <label for="value_320_2"><input type="radio" name="value[320]" id="value_320_2" value="2"
                                                                      />按最后更新时间</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_321_0"><input type="radio" name="value[321]" id="value_321_0" value="0"
            checked="true"                                                          />降序排列</label>
                    <label for="value_321_1"><input type="radio" name="value[321]" id="value_321_1" value="1"
                                                                      />升序排列</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_322_0"><input type="radio" name="value[322]" id="value_322_0" value="0"
                                                                      />列表显示</label>
                    <label for="value_322_1"><input type="radio" name="value[322]" id="value_322_1" value="1"
            checked="true"                                                          />表格显示</label>
                    <label for="value_322_2"><input type="radio" name="value[322]" id="value_322_2" value="2"
                                                                      />文本显示</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_333_0"><input type="radio" name="value[333]" id="value_333_0" value="0"
                                                                      />关闭</label>
                    <label for="value_333_1"><input type="radio" name="value[333]" id="value_333_1" value="1"
            checked="true"                                                          />打开</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_335_0"><input type="radio" name="value[335]" id="value_335_0" value="0"
                                                                      />默认经典</label>
                    <label for="value_335_1"><input type="radio" name="value[335]" id="value_335_1" value="1"
            checked="true"                                                          />流行页码</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_336_0"><input type="radio" name="value[336]" id="value_336_0" value="0"
            checked="true"                                                          />推荐排序</label>
                    <label for="value_336_1"><input type="radio" name="value[336]" id="value_336_1" value="1"
                                                                      />随机显示</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_401_0"><input type="radio" name="value[401]" id="value_401_0" value="1"
            checked="true"                                                          />能</label>
                    <label for="value_401_1"><input type="radio" name="value[401]" id="value_401_1" value="0"
                                                                      />不能</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_402_0"><input type="radio" name="value[402]" id="value_402_0" value="1"
            checked="true"                                                          />使用</label>
                    <label for="value_402_1"><input type="radio" name="value[402]" id="value_402_1" value="0"
                                                                      />不使用</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_403_0"><input type="radio" name="value[403]" id="value_403_0" value="1"
            checked="true"                                                          />使用</label>
                    <label for="value_403_1"><input type="radio" name="value[403]" id="value_403_1" value="0"
                                                                      />不使用</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_404_0"><input type="radio" name="value[404]" id="value_404_0" value="1"
            checked="true"                                                          />使用</label>
                    <label for="value_404_1"><input type="radio" name="value[404]" id="value_404_1" value="0"
                                                                      />不使用</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_405_0"><input type="radio" name="value[405]" id="value_405_0" value="1"
            checked="true"                                                          />使用</label>
                    <label for="value_405_1"><input type="radio" name="value[405]" id="value_405_1" value="0"
                                                                      />不使用</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_406_0"><input type="radio" name="value[406]" id="value_406_0" value="1"
                                                                      />发送邮件</label>
                    <label for="value_406_1"><input type="radio" name="value[406]" id="value_406_1" value="0"
            checked="true"                                                          />不发送邮件</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_407_0"><input type="radio" name="value[407]" id="value_407_0" value="1"
                                                                      />发送邮件</label>
                    <label for="value_407_1"><input type="radio" name="value[407]" id="value_407_1" value="0"
            checked="true"                                                          />不发送邮件</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_408_0"><input type="radio" name="value[408]" id="value_408_0" value="1"
                                                                      />发送邮件</label>
                    <label for="value_408_1"><input type="radio" name="value[408]" id="value_408_1" value="0"
            checked="true"                                                          />不发送邮件</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_409_0"><input type="radio" name="value[409]" id="value_409_0" value="1"
                                                                      />发送邮件</label>
                    <label for="value_409_1"><input type="radio" name="value[409]" id="value_409_1" value="0"
            checked="true"                                                          />不发送邮件</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_410_0"><input type="radio" name="value[410]" id="value_410_0" value="1"
            checked="true"                                                          />必须填写备注</label>
                    <label for="value_410_1"><input type="radio" name="value[410]" id="value_410_1" value="0"
                                                                      />无需填写备注</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_411_0"><input type="radio" name="value[411]" id="value_411_0" value="1"
            checked="true"                                                          />必须填写备注</label>
                    <label for="value_411_1"><input type="radio" name="value[411]" id="value_411_1" value="0"
                                                                      />无需填写备注</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_412_0"><input type="radio" name="value[412]" id="value_412_0" value="1"
            checked="true"                                                          />必须填写备注</label>
                    <label for="value_412_1"><input type="radio" name="value[412]" id="value_412_1" value="0"
                                                                      />无需填写备注</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_413_0"><input type="radio" name="value[413]" id="value_413_0" value="1"
            checked="true"                                                          />必须填写备注</label>
                    <label for="value_413_1"><input type="radio" name="value[413]" id="value_413_1" value="0"
                                                                      />无需填写备注</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_414_0"><input type="radio" name="value[414]" id="value_414_0" value="1"
            checked="true"                                                          />必须填写备注</label>
                    <label for="value_414_1"><input type="radio" name="value[414]" id="value_414_1" value="0"
                                                                      />无需填写备注</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_415_0"><input type="radio" name="value[415]" id="value_415_0" value="1"
            checked="true"                                                          />必须填写备注</label>
                    <label for="value_415_1"><input type="radio" name="value[415]" id="value_415_1" value="0"
                                                                      />无需填写备注</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_416_0"><input type="radio" name="value[416]" id="value_416_0" value="1"
            checked="true"                                                          />必须填写备注</label>
                    <label for="value_416_1"><input type="radio" name="value[416]" id="value_416_1" value="0"
                                                                      />无需填写备注</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_417_0"><input type="radio" name="value[417]" id="value_417_0" value="1"
            checked="true"                                                          />必须填写备注</label>
                    <label for="value_417_1"><input type="radio" name="value[417]" id="value_417_1" value="0"
                                                                      />无需填写备注</label>
      ...
      <script>
        ...
        <td class="panel-par">
                    <textarea name="value[418]" cols="40" rows="5">demo</textarea>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_419_0"><input type="radio" name="value[419]" id="value_419_0" value="1"
            checked="true"                                                          />允许</label>
                    <label for="value_419_1"><input type="radio" name="value[419]" id="value_419_1" value="0"
                                                                      />不允许</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_421_0"><input type="radio" name="value[421]" id="value_421_0" value="1"
                                                                      />是</label>
                    <label for="value_421_1"><input type="radio" name="value[421]" id="value_421_1" value="0"
            checked="true"                                                          />否</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_423_0"><input type="radio" name="value[423]" id="value_423_0" value="1"
                                                                      />下订单时</label>
                    <label for="value_423_1"><input type="radio" name="value[423]" id="value_423_1" value="0"
            checked="true"                                                          />发货时</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_425_0"><input type="radio" name="value[425]" id="value_425_0" value="1"
                                                                      />是</label>
                    <label for="value_425_1"><input type="radio" name="value[425]" id="value_425_1" value="0"
            checked="true"                                                          />否</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_426_0"><input type="radio" name="value[426]" id="value_426_0" value="1"
                                                                      />只显示文字</label>
                    <label for="value_426_1"><input type="radio" name="value[426]" id="value_426_1" value="2"
                                                                      />只显示图片</label>
                    <label for="value_426_2"><input type="radio" name="value[426]" id="value_426_2" value="3"
            checked="true"                                                          />显示文字与图片</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_427_0"><input type="radio" name="value[427]" id="value_427_0" value="1"
            checked="true"                                                          />是</label>
                    <label for="value_427_1"><input type="radio" name="value[427]" id="value_427_1" value="0"
                                                                      />否</label>
      ...
      <script>
        ...
        <table width="90%" id="goods-table" class="gk-table" style="display:none">
                  <tr>
        <td class="label" valign="top">
                    是否显示货号:
        </td>
        <td class="panel-par">
                              <label for="value_701_0"><input type="radio" name="value[701]" id="value_701_0" value="1"
            checked="true"                                                          />显示</label>
                    <label for="value_701_1"><input type="radio" name="value[701]" id="value_701_1" value="0"
                                                                      />不显示</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_702_0"><input type="radio" name="value[702]" id="value_702_0" value="1"
            checked="true"                                                          />显示</label>
                    <label for="value_702_1"><input type="radio" name="value[702]" id="value_702_1" value="0"
                                                                      />不显示</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_703_0"><input type="radio" name="value[703]" id="value_703_0" value="1"
            checked="true"                                                          />显示</label>
                    <label for="value_703_1"><input type="radio" name="value[703]" id="value_703_1" value="0"
                                                                      />不显示</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_704_0"><input type="radio" name="value[704]" id="value_704_0" value="1"
            checked="true"                                                          />显示</label>
                    <label for="value_704_1"><input type="radio" name="value[704]" id="value_704_1" value="0"
                                                                      />不显示</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_705_0"><input type="radio" name="value[705]" id="value_705_0" value="1"
            checked="true"                                                          />显示</label>
                    <label for="value_705_1"><input type="radio" name="value[705]" id="value_705_1" value="0"
                                                                      />不显示</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_706_0"><input type="radio" name="value[706]" id="value_706_0" value="1"
            checked="true"                                                          />单选按钮</label>
                    <label for="value_706_1"><input type="radio" name="value[706]" id="value_706_1" value="0"
                                                                      />下拉列表</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_707_0"><input type="radio" name="value[707]" id="value_707_0" value="1"
            checked="true"                                                          />显示</label>
                    <label for="value_707_1"><input type="radio" name="value[707]" id="value_707_1" value="0"
                                                                      />不显示</label>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_802_0"><input type="radio" name="value[802]" id="value_802_0" value="1"
                                                                      />发短信</label>
                    <label for="value_802_1"><input type="radio" name="value[802]" id="value_802_1" value="0"
            checked="true"                                                          />不发短信</label>
          
                                          <span class="act-hover cl-link" style="margin-left: 20px;cursor:pointer" onmouseenter = "actHover(this)" onmouseleave="actLeave(this)">预览模板</span> <span class="panel-pop"> 您有新订单.收货人:<font color='red'>张三</font> 电话:<font color='red'>13812345678</font></span>
                  </td>
      </tr>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_803_0"><input type="radio" name="value[803]" id="value_803_0" value="1"
                                                                      />发短信</label>
                    <label for="value_803_1"><input type="radio" name="value[803]" id="value_803_1" value="0"
            checked="true"                                                          />不发短信</label>
          
                                          <span class="act-hover cl-link" style="margin-left: 20px;cursor:pointer" onmouseenter = "actHover(this)" onmouseleave="actLeave(this)">预览模板</span> <span class="panel-pop"> 订单 <font color='red'>12345678978945</font> 已付款。收货人：<font color='red'>张三</font>；电话：<font color='red'>13812345678</font>。</span>
                  </td>
      </tr>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_804_0"><input type="radio" name="value[804]" id="value_804_0" value="1"
                                                                      />发短信</label>
                    <label for="value_804_1"><input type="radio" name="value[804]" id="value_804_1" value="0"
            checked="true"                                                          />不发短信</label>
          
                                          <span class="act-hover cl-link" style="margin-left: 20px;cursor:pointer" onmouseenter = "actHover(this)" onmouseleave="actLeave(this)">预览模板</span> <span class="panel-pop"> 订单 <font color='red'>12345678978945</font> 付款了，付款金额：<font color='red'>65.00</font>，我们将立即配货发货。</span>
                  </td>
      </tr>
      ...
      <script>
        ...
        <td class="panel-par">
                              <label for="value_805_0"><input type="radio" name="value[805]" id="value_805_0" value="1"
                                                                      />发短信</label>
                    <label for="value_805_1"><input type="radio" name="value[805]" id="value_805_1" value="0"
            checked="true"                                                          />不发短信</label>
          
                                          <span class="act-hover cl-link" style="margin-left: 20px;cursor:pointer" onmouseenter = "actHover(this)" onmouseleave="actLeave(this)">预览模板</span> <span class="panel-pop"> 您的订单<font color='red'>12345678978945</font>已于<font color='red'>4月30号</font>发货 [<font color='red'>ECSHOP</font>]</span>
                  </td>
      </tr>
...
<div id="footer">
共执行 6 个查询，用时 0.012900 秒，Gzip 已禁用，内存占用 1.620 MB<br />
