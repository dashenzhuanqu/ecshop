<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"C:\Users\Shinelon\Desktop\ecshop\ThinkPHP\public/../application/index\view\goods\coty.html";i:1536305994;}*/ ?>
      ...
      <form enctype="multipart/form-data" action="" method="post" name="theForm" >
        ...
        <table width="90%" id="general-table" align="center" class="gk-table">
          ...
          <tr>
            ...
            <td><select name="cat_id" onchange="hideCatDiv()"><option value="0">请选择...</option><option value="1" >饮料</option><option value="2" >&nbsp;&nbsp;&nbsp;&nbsp;学习</option><option value="3" selected='ture'>笔记本</option><option value="4" >&nbsp;&nbsp;&nbsp;&nbsp;学习</option></select>
                             <span class="require-field">*</span>            </td>
          </tr>
          <tr>
            ...
            <td>
              <input type="button" value="添加" onclick="addOtherCat(this.parentNode)" class="button btn-def" />
                            <select name="other_cat[]"><option value="0">请选择...</option><option value="1" >饮料</option><option value="2" >&nbsp;&nbsp;&nbsp;&nbsp;学习</option><option value="3" selected='ture'>笔记本</option><option value="4" >&nbsp;&nbsp;&nbsp;&nbsp;学习</option></select>
                          </td>
          </tr>
          <tr>
            <td class="label">商品品牌：</td>
            <td><select name="brand_id" onchange="hideBrandDiv()" ><option value="0">请选择...<option value="1">可口可乐</option><option value="2">文档</option><option value="3" selected>联想</option><option value="4">阿萨德股份恢复大师</option></select>
                          </td>
          </tr>
                   <tr>
          ...
          <tr id="promote_4">
            ...
            <td id="promote_6" class="cal-group">
              <input name="promote_start_date" type="text" id="promote_start_date" size="12" value='' readonly="readonly"><button type="button" class="cal" name="selbtn1" id="selbtn1" onclick="return showCalendar('promote_start_date', '%Y-%m-%d', false, false, 'selbtn1');"><img src="static/picture/cal.png" alt=""></button> - <input name="promote_end_date" type="text" id="promote_end_date" size="12" value='' readonly="readonly" /><button type="button" class="cal" name="selbtn2" id="selbtn2" onclick="return showCalendar('promote_end_date', '%Y-%m-%d', false, false, 'selbtn2');"><img src="static/picture/cal.png" alt=""></button>
            </td>
          </tr>
          <tr>
...
<!--            <td><input type="text" name="goods_number" value="1" size="20"  /><br />-->
          ...
          <tr>
            ...
            <td><input type="checkbox" name="is_best" value="1"  />精品 <input type="checkbox" name="is_new" value="1" checked="checked" />新品 <input type="checkbox" name="is_hot" value="1" checked="checked" />热销</td>
          </tr>
          <tr id="alone_sale_1">
        ...
        <table width="90%" id="linkgoods-table" style="display:none" align="center">
          ...
          <tr>
            <td colspan="3">
              ...
              <select name="cat_id1"><option value="0">所有分类<option value="1" >饮料</option><option value="2" >&nbsp;&nbsp;&nbsp;&nbsp;学习</option><option value="3" selected='ture'>笔记本</option><option value="4" >&nbsp;&nbsp;&nbsp;&nbsp;学习</option></select>
              <select name="brand_id1"><option value="0">所有品牌<option value="1">可口可乐</option><option value="2">文档</option><option value="3">联想</option><option value="4">阿萨德股份恢复大师</option></select>
        ...
        <table width="90%" id="groupgoods-table" style="display:none" align="center">
          ...
          <tr>
            <td colspan="3">
              <img src="static/picture/icon_search.svg" width="26" height="22" border="0" alt="SEARCH" />
              <select name="cat_id2"><option value="0">所有分类<option value="1" >饮料</option><option value="2" >&nbsp;&nbsp;&nbsp;&nbsp;学习</option><option value="3" selected='ture'>笔记本</option><option value="4" >&nbsp;&nbsp;&nbsp;&nbsp;学习</option></select>
              <select name="brand_id2"><option value="0">所有品牌<option value="1">可口可乐</option><option value="2">文档</option><option value="3">联想</option><option value="4">阿萨德股份恢复大师</option></select>
...
<div id="footer">
共执行 25 个查询，用时 0.047494 秒，Gzip 已禁用，内存占用 2.128 MB<br />
