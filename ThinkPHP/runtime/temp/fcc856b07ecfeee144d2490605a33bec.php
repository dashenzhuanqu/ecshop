<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:99:"C:\Users\Shinelon\Desktop\ecshop\ThinkPHP\public/../application/index\view\goods\category_edit.html";i:1536306483;}*/ ?>
          ...
          var sel_filter_attr = "请选择筛选属性";
                      arr[1] = new Array();
                                          ...
                                          arr[4][0] = ["长度", 64];
                                                        ...
                                                        arr[4][19] = ["宽度", 65];
                                                        arr[4][20] = ["红外/蓝牙", 80];
                                                        arr[4][21] = ["副屏参数/外屏参数", 61];
                                                        arr[4][22] = ["随机配件", 76];
                                                        arr[4][23] = ["支持频率/网络频率", 57];
                                                        arr[4][24] = ["标准配置", 72];
                                                        arr[4][25] = ["内存容量", 68];
                                                arr[5] = new Array();
                                          arr[5][0] = ["显示芯片", 94];
