<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:92:"C:\Users\Shinelon\Desktop\ecshop\ThinkPHP\public/../application/index\view\adds\success.html";i:1536717539;}*/ ?>
    ...
    <div style="background:#FFF; padding: 20px 50px; margin: 2px;">
        <table align="center" width="400">
            <tbody><tr>
                ...
                <td style="font-size: 14px; font-weight: bold">操作成功!</td>
            </tr>
            <tr>
                <td></td>
            ...
            <tr>
                ...
                <td>
                    <ul style="margin:0; padding:0 10px" class="msg-link">
                        <li><a href="/index/adds/Adds">返回广告位置列表</a></li>
                    </ul>
