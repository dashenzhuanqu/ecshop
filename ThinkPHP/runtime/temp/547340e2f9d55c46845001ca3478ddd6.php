<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:105:"D:\phpStudy\PHPTutorial\WWW\da1\ecshop\ThinkPHP\public/../application/index\view\privilege\suppliers.html";i:1536568858;}*/ ?>
...
>>>>>>> caef6ce988b066b906a5933aa36a429782ee76f3:ThinkPHP/runtime/temp/547340e2f9d55c46845001ca3478ddd6.php
...
<!--<div class="form-div">-->
<form action="{:url('goods/brand_list')}" method="post">
...
<div class="list-div" id="listDiv">
    <table cellpadding="3" cellspacing="1">
        ...
        <tr>
            ...
            <td align="center">
                ...
                <img src="picture/yes.svg" class="is_show" id="{$v.b_id}" value="{$v.is_show}" width="20"/>
                {else/}
                <img src="picture/no.svg" class="is_show" id="{$v.b_id}" value="{$v.is_show}" width="20"/>
                {/in}
            </td>
            <td align="center">
                <a href="{:url('goods/brand_edit')}?id={$v.b_id}" title="编辑">编辑</a> |
                <a href="{:url('goods/brand_del')}?id={$v.b_id}" title="编辑">移除</a>
            </td>
        </tr>
        {/foreach}
    </table>
    ...
    <center><div>{$data->render()}</div></center>
    ...
    <!-- end brand list -->
=======
      <a class="btn btn-right" href="suppliers.php?act=add">添加供货商</a>
  ...
  <table cellpadding="3" cellspacing="1">
    <tr>
      <th> <input onclick='listTable.selectAll(this, "checkboxes")' type="checkbox" />
          <a href="javascript:listTable.sort('suppliers_id'); ">编号</a><img src="static/picture/sort_desc.png"> </th>
      ...
      <th>操作</th>
        ...
        <tr>
      <td><input type="checkbox" name="checkboxes[]" value="1" />
        1</td>
      <td class="first-cell">
        <span onclick="javascript:listTable.edit(this, 'edit_suppliers_name', 1)">北京供货商      </span></td>
      <td>北京供货商</td>
			<td align="center"><img src="static/picture/yes.svg" width="20" onclick="listTable.toggle(this, 'is_check', 1)" style="cursor:pointer;"/></td>
      <td align="center">
        <a href="suppliers.php?act=edit&id=1" title="编辑">编辑</a> |
        <a href="javascript:void(0);" onclick="listTable.remove(1, '您确认要删除这条记录吗?')" title="移除">移除</a>      </td>
    </tr>
        <tr>
      ...
      <td>上海供货商</td>
			<td align="center"><img src="static/picture/yes.svg" width="20" onclick="listTable.toggle(this, 'is_check', 2)" style="cursor:pointer;"/></td>
      <td align="center">
...
<div id="footer">
共执行 4 个查询，用时 0.008431 秒，Gzip 已禁用，内存占用 1.109 MB<br />
版权所有 &copy; 2005-2018 上海商派软件有限公司，并保留所有权利。</div>
>>>>>>> caef6ce988b066b906a5933aa36a429782ee76f3:ThinkPHP/runtime/temp/547340e2f9d55c46845001ca3478ddd6.php
<!-- 新订单提示信息 -->
<div id="popMsg">
...
<script>
    $(document).on('click','.is_show',function(){
        ...
        var obj = $(this);
        $.ajax({
            url:"{:url('goods/brand_change_show')}",
