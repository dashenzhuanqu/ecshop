<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:99:"C:\Users\Shinelon\Desktop\ecshop\ThinkPHP\public/../application/admin\view\admin\user_register.html";i:1537251383;}*/ ?>
  ...
  <div class="usBox_2 clearfix">
   <div class="regtitle"></div>
    <form action="user.php" method="post" name="formUser" onsubmit="return register();">
      ...
      <img id="captcha" src="admin/picture/captcha.php" alt="captcha" style="vertical-align: middle;cursor: pointer;" onClick="this.src='captcha.php?'+Math.random()" />
