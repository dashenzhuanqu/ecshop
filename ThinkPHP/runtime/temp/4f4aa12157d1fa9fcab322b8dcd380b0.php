<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:95:"C:\Users\Shinelon\Desktop\ecshop\ThinkPHP\public/../application/index\view\money\money_add.html";i:1536287581;}*/ ?>
...
<!--遮罩-->
<h1>
    <a class="btn btn-right" href="/index/money/money">红包类型</a>
    ...
    <form action="/index/money/money_insert" method="post" name="theForm" enctype="multipart/form-data" onsubmit="return validate()">
        <table width="100%">
            <tbody><tr>
                <td class="label">类型名称</td>
                <td>
                    <input type="text" name="type_type" maxlength="30" value="" size="20">    </td>
            </tr>
            <tr>
                <td class="label">
                ...
                <td>
                    <input type="text" name="type_money" value="" size="20">
            ...
            <tr>
                ...
                <td><input name="money_money" type="text" id="min_goods_amount" value="" size="20">
            ...
            <tr>
                ...
                <td>
                    <input name="send_start_date" type="datetime-local" id="send_start_date" size="12">
            ...
            <tr>
                ...
                <td>
                    <input name="send_end_date" type="datetime-local" id="send_end_date" size="12">
                </td>
            </tr>
            <tr>
                <td class="label">
                    ...
                    使用起始日期</td>
                <td>
                    <input name="use_start_date" type="datetime-local" id="use_start_date" size="12">
            ...
            <tr>
                ...
                <td>
                    <input name="use_end_date" type="datetime-local" id="use_end_date" size="12"> </td>
            </tr>
            <tr>
                <td class="label">&nbsp;</td>
                <td>
