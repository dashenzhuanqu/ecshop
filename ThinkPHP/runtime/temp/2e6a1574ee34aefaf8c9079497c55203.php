<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:100:"C:\Users\Shinelon\Desktop\ecshop\ThinkPHP\public/../application/index\view\goods\goods_type_add.html";i:1536539189;}*/ ?>
...
<div class="main-div">
  <form action="<?php echo url('goods/goods_types'); ?>" method="post">
    <table cellspacing="1" cellpadding="3" width="100%">
      <tr>
        <td class="label">商品类型名称:</td>
        <td><input type="text" name="goods_type_name" value="" size="40" />
      ...
      <tr>
        ...
        <td>
          <textarea name="classs" rows="5" cols="40"></textarea><br />
