<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:110:"G:\CodeFile\WWW\month12\perject\ecshop\ThinkPHP\public/../application/index\view\user\user_account_manage.html";i:1536654265;}*/ ?>
...
</h1><script type="text/javascript" src="static/js/utils.js"></script><script type="text/javascript" src="static/js/listtable.js"></script><script type="text/javascript" src="static/js/calendar.js"></script>
...
<div class="form-div">
  <form name="TimeInterval" action="user_account_manage.php" method="post" style="margin:0px">
    开始日期&nbsp;
    <input name="start_date" type="text" id="start_date" size="15" value='2018-09-03' readonly="readonly" />
    ...
    结束日期&nbsp;
    <input name="end_date" type="text" id="end_date" size="15" value='2018-09-10' readonly="readonly" />
...
<table cellspacing='1' cellpadding='3'>
  ...
  <tr>
    <td width="20%"><a href="user_account.php?act=list&process_type=0&ispaid=1&start_date=2018-09-03&end_date=2018-09-10">用户充值总额</a></td>
    <td width="30%"><strong>￥0.00元</strong></td>
    <td width="20%"><a href="user_account.php?act=list&process_type=1&ispaid=1&start_date=2018-09-03&end_date=2018-09-10">提现金额</a></td>
    <td width="30%"><strong>￥0.00元</strong></td>
  </tr>
  <tr>
...
<table cellspacing='1' cellpadding='3'>
  ...
  <tr>
    <td width="20%"><a href="user_account_manage.php?act=surplus&start_date=2018-09-03&end_date=2018-09-10">交易使用余额</a></td>
    <td width="30%"><strong>￥0.00元</strong></td>
    <td width="20%"><a href="user_account_manage.php?act=surplus&start_date=2018-09-03&end_date=2018-09-10">积分使用余额</a></td>
    <td width="30%"><strong >￥0.00元</strong></td>
  </tr>
  <tr>
...
<div id="footer">
共执行 6 个查询，用时 0.043230 秒，Gzip 已禁用，内存占用 1.380 MB<br />
