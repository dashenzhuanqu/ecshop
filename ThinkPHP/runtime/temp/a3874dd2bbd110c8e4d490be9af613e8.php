<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:101:"G:\CodeFile\WWW\month12\perject\ecshop\ThinkPHP\public/../application/index\view\goods\goods_add.html";i:1536841836;}*/ ?>
...
<div class="tab-div">
    ...
    <!-- tab body -->
    <div id="tabbody-div">
      <form enctype="multipart/form-data" action="<?php echo url('goods/goods_adds'); ?>" method="post">
        <!-- 鏈€澶ф枃浠堕檺鍒 -->
        ...
        <table width="90%" id="general-table" align="center" class="gk-table">
          ...
          <tr>
            ...
            <td><input type="text" name="goods_art" value="" size="20" onblur="checkGoodsSn(this.value,'0')" /><span id="goods_sn_notice"></span><br />
          ...
          <tr>
            ...
            <td><input type="text" name="mall_price" value="0" size="20" />
          ...
          <tr>
            ...
            <td id="promote_3"><input type="text" id="promote_1" name="vip_price" value="0" size="20" /></td>
          </tr>
          <tr id="promote_4">
            <td class="label" id="promote_5">促销日期：</td>
            <td id="promote_6" class="cal-group">
              <input name="add_time" type="datetime-local" id="promote_start_date" size="12" ><img src="../../../static/picture/cal.png" alt=""></button> - <input name="end_time" type="datetime-local" id="promote_end_date" size="12"/><img src="../../../static/picture/cal.png" alt=""></button>
            </td>
          </tr>
          <tr>
...
<!--            <td><input type="text" name="goods_number" value="1" size="20"  /><br />-->
            <td><input type="text" name="suk" value="1" size="20" /><br />
