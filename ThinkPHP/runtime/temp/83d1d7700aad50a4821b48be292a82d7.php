<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:92:"C:\Users\Shinelon\Desktop\ecshop\ThinkPHP\public/../application/index\view\adds\Ads_add.html";i:1536321993;}*/ ?>
...
<!--遮罩-->
<h1>
    <a class="btn btn-right" href="/index/adds/adds">广告位置</a>
    ...
    <form action="/index/adds/Ads_insert" method="post" name="theForm" enctype="multipart/form-data" onsubmit="return validate()">
        <table width="100%">
            <tbody><tr>
                <td class="label">广告位名称</td>
                <td><input type="text" name="ads_name" value="" size="30"></td>
            </tr>
            <tr>
                <td class="label">广告位宽度</td>
                <td><input type="text" name="ads_width" value="" size="30"> 像素</td>
            </tr>
            <tr>
                <td class="label">广告位高度</td>
                <td>
                    <input type="text" name="ads_height" value="" size="30"> 像素        </td>
            </tr>
            <tr>
                <td class="label">广告位描述</td>
                <td>
                    <input type="text" name="ads_descs" size="55" value="">
                </td>
            </tr>
            <tr>
                <td class="label">广告位模板</td>
                <td>
          <textarea name="ads_template" cols="55" rows="6"></textarea>
                </td>
            </tr>
            <tr>
                <td class="label">&nbsp;</td>
...
<div id="footer">
    共执行 2 个查询，用时 0.012001 秒，Gzip 已禁用，内存占用 1.340 MB<br>
