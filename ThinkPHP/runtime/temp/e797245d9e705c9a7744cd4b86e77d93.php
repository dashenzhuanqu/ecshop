<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"C:\Users\Shinelon\Desktop\ecshop\ThinkPHP\public/../application/index\view\goods\goods.html";i:1536308828;}*/ ?>
...
<!--遮罩-->
<h1>
    <a class="btn btn-right" href="/index/goods/goods_list">商品列表</a>
...
</h1><script type="text/javascript" src="../../../static/js/utils.js"></script><script type="text/javascript" src="../../../static/js/selectzone.js"></script><script type="text/javascript" src="../../../static/js/colorselector.js"></script><script type="text/javascript" src=../../../static/js/calendar.php?lang="></script>
<link href="../../../static/js/calendar/calendar.css" rel="stylesheet" type="text/css">
        ...
        <form enctype="multipart/form-data" action="" method="post" name="theForm">
            ...
            <table width="90%" id="general-table" align="center" class="gk-table">
                <tbody><tr>
                    ...
                    <td><input type="text" name="goods_name" value="联想" style="float:left;color:;" size="30"><div style="background-color:;float:left;margin-left:2px;" id="font_color" onclick="ColorSelecter.Show(this);"><img src="../../../static/images/color_selecter.gif" style="margin-top:-1px;"></div><input type="hidden" id="goods_name_color" name="goods_name_color" value="">&nbsp;
                ...
                <tr>
                    <td class="label">
                        <a href="javascript:showNotice('noticeGoodsSN');" title="点击此处查看提示信息"><img src="../../../static/images/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 商品货号： </td>
                    <td><input type="text" name="goods_sn" value="ECS000004" size="20" onblur="checkGoodsSn(this.value,'4')"><span id="goods_sn_notice"></span><br>
                        <span class="notice-span" style="display:block" id="noticeGoodsSN">如果您不输入商品货号，系统将自动生成一个唯一的货号。</span></td>
                </tr>
                <tr>
                    <td class="label">商品分类：</td>
                    <td><select name="cat_id" onchange="hideCatDiv()"><option value="0">请选择...</option><option value="3" selected="ture">笔记本</option><option value="1">饮料</option><option value="2">&nbsp;&nbsp;&nbsp;&nbsp;学习</option></select>
               ...
               <button type="button" class="btn btn-def " onclick="hideCatDiv()" title="隐藏">&lt;&lt;</button>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <select name="other_cat[]"><option value="0">请选择...</option><option value="3" selected="ture">笔记本</option><option value="1">饮料</option><option value="2">&nbsp;&nbsp;&nbsp;&nbsp;学习</option></select>
                    </td>
                </tr>
                <tr>
                    <td class="label">商品品牌：</td>
                    <td><select name="brand_id" onchange="hideBrandDiv()"><option value="0">请选择...</option><option value="1">可口可乐</option><option value="2">文档</option><option value="3" selected="">联想</option><option value="4">阿萨德股份恢复大师</option></select>
              ...
              <input type="text" class="text" size="15" name="addedBrandName">
               ...
               <button type="button" class="btn btn-def " onclick="hideBrandDiv()" title="隐藏">&lt;&lt;</button>
                ...
                <tr>
                    ...
                    <td><input type="text" name="shop_price" value="4000.00" size="20" onblur="priceSetted()">
                        <input type="button" class="btn btn-def" value="按市场价计算" onclick="marketPriceSetted()">
                        <span class="require-field">*</span></td>
                </tr>
                <tr>
                    <td class="label"><a href="javascript:showNotice('noticeUserPrice');" title="点击此处查看提示信息"><img src="../../../static/images/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>会员价格：</td>
                    <td>
                        注册用户<span id="nrank_1">(4000)</span><input type="text" id="rank_1" name="user_price[]" value="-1" onkeyup="if(parseInt(this.value)<-1){this.value='-1';};set_price_note(1)" size="8">
                ...
                <!--鍟嗗搧浼樻儬浠锋牸-->
                <tr>
                    <td class="label"><a href="javascript:showNotice('volumePrice');" title="点击此处查看提示信息"><img src="../../../static/images/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>商品优惠价格：</td>
                    <td>
                        <table width="100%" id="tbody-volume" align="center">
                            <tbody><tr>
                                <td>
                                    <a href="javascript:;" onclick="addVolumePrice(this)">[+]</a>
                                    优惠数量 <input type="text" name="volume_number[]" size="8" value="100">
                                    优惠价格 <input type="text" name="volume_price[]" size="8" value="300.00">
                                </td>
                            </tr>
                            </tbody></table>
                ...
                <tr>
                    ...
                    <td><input type="text" name="market_price" value="4800.00" size="20">
                ...
                <tr>
                    <td class="label"><a href="javascript:showNotice('giveIntegral');" title="点击此处查看提示信息"><img src="../../../static/images/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 赠送消费积分数：</td>
                ...
                <tr>
                    <td class="label"><a href="javascript:showNotice('rankIntegral');" title="点击此处查看提示信息"><img src="../../../static/images/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 赠送等级积分数：</td>
                ...
                <tr>
                    <td class="label"><a href="javascript:showNotice('noticPoints');" title="点击此处查看提示信息"><img src="../../../static/images/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 积分购买金额：</td>
                    <td><input type="text" name="integral" value="40" size="20" onblur="parseint_integral()" ;="">
                ...
                <tr id="promote_4">
                    ...
                    <td id="promote_6" class="cal-group">
                        <input name="promote_start_date" type="datetime-local" id="promote_start_date" size="12" value=""><button type="button" class="cal" name="selbtn1" id="selbtn1" onclick="return showCalendar('promote_start_date', '%Y-%m-%d', false, false, 'selbtn1');" disabled=""><img src="../../../static/images/cal.png" alt=""></button> - <input name="promote_end_date" type="datetime-local" id="promote_end_date" size="12" value="" ><button type="button" class="cal" name="selbtn2" id="selbtn2" onclick="return showCalendar('promote_end_date', '%Y-%m-%d', false, false, 'selbtn2');" disabled=""><img src="../../../static/images/cal.png" alt=""></button>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="goods.php?act=show_image&amp;img_url=images/201809/goods_img/4_G_1536199583655.jpg" target="_blank"><img src="../../../static/images/yes.svg" width="16"></a>
                ...
                <tr id="auto_thumb_1">
                    ...
                    <td id="auto_thumb_3">
                        ...
                        <a href="goods.php?act=show_image&amp;img_url=images/201809/thumb_img/4_thumb_G_1536199583356.jpg" target="_blank"><img src="../../../static/images/yes.svg" width="16"></a>
            ...
            <table width="90%" id="mix-table" style="display:none" align="center">
                ...
                <tr>
                    <td class="label"><a href="javascript:showNotice('noticeStorage');" title="点击此处查看提示信息"><img src="../../../static/images/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 商品库存数量：</td>
                ...
                <tr>
                    ...
                    <td><input type="checkbox" name="is_best" value="1">精品 <input type="checkbox" name="is_new" value="1">新品 <input type="checkbox" name="is_hot" value="1" checked="checked">热销</td>
                </tr>
                <tr id="alone_sale_1">
                ...
                <tr>
                    <td class="label">
                        <a href="javascript:showNotice('noticeSellerNote');" title="点击此处查看提示信息"><img src="../../../static/images/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 商家备注： </td>
            ...
            <table width="90%" id="properties-table" style="display:none" align="center">
                <tbody><tr>
                    <td class="label"><a href="javascript:showNotice('noticeGoodsType');" title="点击此处查看提示信息"><img src="../../../static/images/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>商品类型：</td>
                    <td>
                        <select name="goods_type" onchange="getAttrList(4)">
            ...
            <table width="90%" id="gallery-table" style="display:none" align="center">
                ...
                <tbody><tr>
                    <td>
                        <div id="gallery_4" style="float:left; text-align:center; border: 1px solid #DADADA; margin: 4px; padding:2px;">
                            <a href="javascript:;" onclick="if (confirm('您确实要删除该图片吗？')) dropImg('4')">[-]</a><br>
                            <a href="goods.php?act=show_image&amp;img_url=images/201809/goods_img/4_P_1536199583376.jpg" target="_blank">
                                <img src="../static/images/201809/thumb_img/4_thumb_P_1536199583890.jpg" width="100" height="100" border="0">
                            </a><br>
                            <input type="text" value="" size="15" name="old_img_desc[4]">
                        </div>
                    </td>
                </tr>
                <tr><td>&nbsp;</td></tr>
            ...
            <table width="90%" id="linkgoods-table" style="display:none" align="center">
                ...
                <tbody><tr>
                    <td colspan="3">
                        ...
                        <select name="cat_id1"><option value="0">所有分类</option><option value="3" selected="ture">笔记本</option><option value="1">饮料</option><option value="2">&nbsp;&nbsp;&nbsp;&nbsp;学习</option></select>
                        <select name="brand_id1"><option value="0">所有品牌</option><option value="1">可口可乐</option><option value="2">文档</option><option value="3">联想</option><option value="4">阿萨德股份恢复大师</option></select>
            ...
            <table width="90%" id="groupgoods-table" style="display:none" align="center">
                ...
                <tbody><tr>
                    <td colspan="3">
                        <img src="../../../static/images/icon_search.svg" width="26" height="22" border="0" alt="SEARCH">
                        <select name="cat_id2"><option value="0">所有分类</option><option value="3" selected="ture">笔记本</option><option value="1">饮料</option><option value="2">&nbsp;&nbsp;&nbsp;&nbsp;学习</option></select>
                        <select name="brand_id2"><option value="0">所有品牌</option><option value="1">可口可乐</option><option value="2">文档</option><option value="3">联想</option><option value="4">阿萨德股份恢复大师</option></select>
            ...
            <div class="button-div">
                ...
                <input type="button" value=" 确定 " class="button" onclick="validate('4')">
...
<!-- end goods form -->
<script type="text/javascript" src="../../../static/js/validator.js"></script><script type="text/javascript" src="js/tab.js"></script>
...
<div id="footer">
    共执行 16 个查询，用时 0.055516 秒，Gzip 已禁用，内存占用 2.126 MB<br>
