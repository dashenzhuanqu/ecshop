<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"C:\Users\Shinelon\Desktop\ecshop\ThinkPHP\public/../application/index\view\goods\goods.html";i:1536207019;}*/ ?>
...
<!--遮罩-->
<h1>
    <a class="btn btn-right" href="goods.php?act=list&amp;uselastfilter=1">商品列表</a>
        ...
        <form enctype="multipart/form-data" action="" method="post" name="theForm">
            ...
            <table width="90%" id="general-table" align="center" class="gk-table">
                <tbody><tr>
                    ...
                    <td><input type="text" name="goods_name" value="联想" style="float:left;color:;" size="30"><div style="background-color:;float:left;margin-left:2px;" id="font_color" onclick="ColorSelecter.Show(this);"><img src="images/color_selecter.gif" style="margin-top:-1px;"></div><input type="hidden" id="goods_name_color" name="goods_name_color" value="">&nbsp;
                ...
                <tr>
                    <td class="label">
                        <a href="javascript:showNotice('noticeGoodsSN');" title="点击此处查看提示信息"><img src="images/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 商品货号： </td>
              ...
              <input type="text" class="text" size="15" name="addedBrandName">
               ...
               <button type="button" class="btn btn-def " onclick="hideBrandDiv()" title="隐藏">&lt;&lt;</button>
                ...
                <tr>
                    <td class="label"><a href="javascript:showNotice('noticeUserPrice');" title="点击此处查看提示信息"><img src="images/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>会员价格：</td>
                    <td>
                ...
                <!--鍟嗗搧浼樻儬浠锋牸-->
                <tr>
                    <td class="label"><a href="javascript:showNotice('volumePrice');" title="点击此处查看提示信息"><img src="images/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>商品优惠价格：</td>
                    <td>
                ...
                <tr>
                    <td class="label"><a href="javascript:showNotice('giveIntegral');" title="点击此处查看提示信息"><img src="images/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 赠送消费积分数：</td>
                ...
                <tr>
                    <td class="label"><a href="javascript:showNotice('rankIntegral');" title="点击此处查看提示信息"><img src="images/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 赠送等级积分数：</td>
                ...
                <tr>
                    <td class="label"><a href="javascript:showNotice('noticPoints');" title="点击此处查看提示信息"><img src="images/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 积分购买金额：</td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="goods.php?act=show_image&amp;img_url=images/201809/goods_img/4_G_1536199583655.jpg" target="_blank"><img src="images/yes.svg" width="16"></a>
                ...
                <tr id="auto_thumb_1">
                    ...
                    <td id="auto_thumb_3">
                        ...
                        <a href="goods.php?act=show_image&amp;img_url=images/201809/thumb_img/4_thumb_G_1536199583356.jpg" target="_blank"><img src="images/yes.svg" width="16"></a>
                    ...
                    <td>
                        <div id="gallery_4" style="float:left; text-align:center; border: 1px solid #DADADA; margin: 4px; padding:2px;">
                            ...
                            <a href="goods.php?act=show_image&amp;img_url=images/201809/goods_img/4_P_1536199583376.jpg" target="_blank">
                                <img src="../images/201809/thumb_img/4_thumb_P_1536199583890.jpg" width="100" height="100" border="0">
                            </a><br>
...
<!-- end goods form -->
<script type="text/javascript" src="js/validator.js"></script><script type="text/javascript" src="js/tab.js"></script>
