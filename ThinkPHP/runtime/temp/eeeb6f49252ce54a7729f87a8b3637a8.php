<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:109:"G:\CodeFile\WWW\month12\perject\ecshop\ThinkPHP\public/../application/index\view\goods\goods_type_manage.html";i:1536537637;}*/ ?>
...
<!--<script type="text/javascript" src="../../../static/js/utils.js"></script><script type="text/javascript" src="../../../static/js/listtable.js"></script>-->
...
<table width="100%" cellpadding="3" cellspacing="1" id="listTable">
  ...
  <?php foreach($arr as $k =>$v): ?>
    <tr>
    <td class="first-cell"><span><?php echo $v['goods_type_name']; ?></span></td>
    <td align="right"><?php echo $v['classs']; ?></td>
    <td align="right"><?php echo $v['num']; ?></td>
    <td align="center">
        <?php if(in_array(($v['is_new']), explode(',',"1"))): ?>
        <img src="../../../static/picture/yes.svg" class="is_new" id="<?php echo $v['t_id']; ?>" value="<?php echo $v['is_new']; ?>" width="20"/>
        <?php else: ?>
        <img src="../../../static/picture/no.svg" class="is_new" id="<?php echo $v['t_id']; ?>" value="<?php echo $v['is_new']; ?>" width="20"/>
        <?php endif; ?></td>
    <td align="center">
      <a href="<?php echo url('goods/attribute_list'); ?>?id=<?php echo $v['t_id']; ?>" title="属性列表">属性列表</a> |
      <a href="<?php echo url('goods/goods_type_edit'); ?>?id=<?php echo $v['t_id']; ?>" title="编辑">编辑</a> |
      <a href="<?php echo url('goods/goods_type_del'); ?>?id=<?php echo $v['t_id']; ?>" title="移除">移除</a>
    </td>
  </tr>
  <?php endforeach; ?>
</table>
...
<script>
    $(document).on('click','.is_new',function(){
        ...
        var obj=$(this);
        $.ajax({
            url:"<?php echo url('goods/goods_type_show'); ?>",
            data:{t_id:t_id,status:status},
            dataType:"json",
