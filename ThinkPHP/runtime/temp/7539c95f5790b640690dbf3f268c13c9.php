<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:102:"G:\CodeFile\WWW\month12\perject\ecshop\ThinkPHP\public/../application/index\view\index\index_menu.html";i:1537349429;}*/ ?>
      ...
      <ul class="menu" id="menu-ul">
          ...
          商品管理                    <div class="submenu">
            ...
            <ul>
                          ...
                          <li key="03_promotion" class="icon-promotion" data-url="<?php echo url('money/money'); ?>" data-key="04_bonustype_list" name="menu" onclick="showsub(this)">
          促销管理                    <div class="submenu">
            <div class="title">促销管理</div>
            <ul>
                          <li id="sub-menu-04_bonustype_list" class="menu-item" onclick="showact(this, event)"><a href="<?php echo url('money/money'); ?>" target="main-frame">红包类型</a></li>
                          ...
                          <li key="04_order" class="icon-order" data-url="<?php echo url('order/orders_list'); ?>" data-key="02_order_list" name="menu" onclick="showsub(this)">
          订单管理                    <div class="submenu">
            <div class="title">订单管理</div>
            <ul>
                          <li id="sub-menu-02_order_list" class="menu-item" onclick="showact(this, event)"><a href="<?php echo url('order/orders_list'); ?>" target="main-frame">订单列表</a></li>
                          <li id="sub-menu-03_order_query" class="menu-item" onclick="showact(this, event)"><a href="<?php echo url('order/orders_query'); ?>" target="main-frame">订单查询</a></li>
                          <li id="sub-menu-04_merge_order" class="menu-item" onclick="showact(this, event)"><a href="<?php echo url('order/merge_orders'); ?>" target="main-frame">合并订单</a></li>
                          <li id="sub-menu-05_edit_order_print" class="menu-item" onclick="showact(this, event)"><a href="<?php echo url('order/orders_printing'); ?>" target="main-frame">订单打印</a></li>
                          <li id="sub-menu-06_undispose_booking" class="menu-item" onclick="showact(this, event)"><a href="<?php echo url('order/shortage_registration'); ?>" target="main-frame">缺货登记</a></li>
                          <li id="sub-menu-08_add_order" class="menu-item" onclick="showact(this, event)"><a href="<?php echo url('order/user_order'); ?>" target="main-frame">添加订单</a></li>
                          <li id="sub-menu-09_delivery_order" class="menu-item" onclick="showact(this, event)"><a href="<?php echo url('order/list_invoice'); ?>" target="main-frame">发货单列表</a></li>
                          <li id="sub-menu-10_back_order" class="menu-item" onclick="showact(this, event)"><a href="<?php echo url('order/list_return'); ?>" target="main-frame">退货单列表</a></li>
                        </ul>
          </div>
                  </li>
                          <li key="05_banner" class="icon-banner" data-url="<?php echo url('add/add'); ?>" data-key="ad_list" name="menu" onclick="showsub(this)">
          广告管理                    <div class="submenu">
            <div class="title">广告管理</div>
            <ul>
                          <li id="sub-menu-ad_list" class="menu-item" onclick="showact(this, event)"><a href="<?php echo url('add/add'); ?>" target="main-frame">广告列表</a></li>
                          <li id="sub-menu-ad_position" class="menu-item" onclick="showact(this, event)"><a href="<?php echo url('adds/adds'); ?>" target="main-frame">广告位置</a></li>
                        </ul>
          </div>
                  </li>
          ...
          系统设置                    <div class="submenu">
            ...
            <ul>
                          <li id="sub-menu-01_shop_config" class="menu-item" onclick="showact(this, event)"><a href="<?php echo url('system/system_list'); ?>" target="main-frame">商店设置</a></li>
                          <li id="sub-menu-021_reg_fields" class="menu-item" onclick="showact(this, event)"><a href="<?php echo url('system/system_hy'); ?>" target="main-frame">会员注册项设置</a></li>
                          <li id="sub-menu-02_payment_list" class="menu-item" onclick="showact(this, event)"><a href="<?php echo url('system/system_zc'); ?>" target="main-frame">支付方式</a></li>
                          <li id="sub-menu-03_shipping_list" class="menu-item" onclick="showact(this, event)"><a href="<?php echo url('system/system_ps'); ?>" target="main-frame">配送方式</a></li>
                          <li id="sub-menu-04_mail_settings" class="menu-item" onclick="showact(this, event)"><a href="<?php echo url('system/system_hy'); ?>" target="main-frame">邮件服务器设置</a></li>
                          <li id="sub-menu-05_area_list" class="menu-item" onclick="showact(this, event)"><a href="<?php echo url('system/system_dq'); ?>" target="main-frame">地区列表</a></li>
                          <!--<li id="sub-menu-07_cron_schcron" class="menu-item" onclick="showact(this, event)"><a href="<?php echo url('system/system_hy'); ?>" target="main-frame">计划任务</a></li>-->
                          <li id="sub-menu-08_friendlink_list" class="menu-item" onclick="showact(this, event)"><a href="<?php echo url('system/system_yq'); ?>" target="main-frame">友情链接</a></li>
  ...
  <div id="foot-div" onmouseover="showBar(this)" onmouseout="hideBar(this)">
    ...
    <div class="panel-hint">
      <ul>
        ...
        <!--</li>-->
        <li class="btn-exit">
          <a href="<?php echo url('login/privilege_logout'); ?>" target="_top" class="fix-submenu">退出</a>
        </li>
      </ul>
    </div>
  </div>
