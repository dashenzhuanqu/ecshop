<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:108:"D:\phpStudy\PHPTutorial\WWW\da1\ecshop\ThinkPHP\public/../application/index\view\privilege\addprivilege.html";i:1536311601;}*/ ?>
...
<!--遮罩-->
<h1>
      <a class="btn btn-right" href="<?php echo url('privilege/privilege'); ?>">管理员列表</a>
    <span class="action-span1"><a href="<?php echo url('ads/main'); ?>">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1">&nbsp;&nbsp;&gt;&nbsp;&nbsp;添加管理员 </span>
  <div style="clear:both"></div>
</h1><div class="main-div">
<form name="theForm" method="post" enctype="multipart/form-data" onsubmit="return validate();" id="theForm">
<table width="100%">
  <tbody><tr>
  ...
  <tr>
    ...
    <td>
      <input name="email" size="34" type="text"><span class="require-field">*</span></td>
  </tr>
   <tr>
    <td class="label">密码</td>
    <td>
      <input name="user_pwd" maxlength="32" size="34" type="password"><span class="require-field">*</span></td>
  </tr>
  <tr>
    <td class="label">确认密码</td>
    <td>
      <input name="pwd_confirm" maxlength="32" size="34" type="password"><span class="require-field">*</span></td>
  </tr>
           <tr>
...
<!--       <input name="act" value="insert" type="hidden">
      ...
      <!-- <input name="id" value="" type="hidden"></td> -->
  </tr>
</tbody></table>
</form>
</div>
<script type="text/javascript" src="__PUBLIC__/static/js/utils.js"></script><script type="text/javascript" src="__PUBLIC__/static/js/validator.js"></script><script language="JavaScript">
var action = "add";
<!--
...
<div id="footer">
共执行 3 个查询，用时 0.010610 秒，Gzip 已禁用，内存占用 1.424 MB<br>
...
<script src="../../../public/static/js/jquery-2.1.4.min.js"></script>
<script>
$(".button").click(function(){
  var theForm = $(".button").serialize();
    
    $.ajax({
      url:"<?php echo url('privilege/privilege'); ?>",
      type:'post',
      data:theForm,
      dataType:'json',
