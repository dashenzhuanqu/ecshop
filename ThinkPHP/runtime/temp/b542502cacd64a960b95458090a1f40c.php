<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:92:"C:\Users\Shinelon\Desktop\ecshop\ThinkPHP\public/../application/index\view\money\update.html";i:1536712431;}*/ ?>
<html xmlns="http://www.w3.org/1999/xhtml"><head><script src="//hm.baidu.com/hm.js?dde6ba2851f3db0ddc415ce0f895822e"></script><script type="text/javascript"></script>
...
<!--遮罩-->
<h1>
    <a class="btn btn-right" href="/index/money/money_update">红包类型</a>
    ...
    <form action="/index/money/money_update" method="post">
        ...
        <table width="100%">
            <tbody><tr>
                ...
                <td>
                    <input type="text" name="type_type" maxlength="30" value="<?= $v['type_type']?>" size="20">    </td>
                <input type="hidden" name="type_id" value="<?= $v['type_id']?>">
            </tr>
            <tr>
                <td class="label">
                    <a href="javascript:showNotice('Type_money_a');" title="点击此处查看提示信息">
                        <img src="../../../static/picture/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>红包金额</td>
                <td>
                    <input type="text" name="type_money" value="<?= $v['type_money']?>" size="20">
                    <br><span class="notice-span" style="display:block" id="Type_money_a">此类型的红包可以抵销的金额</span>    </td>
            </tr>
            <tr>
                <td class="label"><a href="javascript:showNotice('NoticeMinGoodsAmount');" title="点击此处查看提示信息"> <img src="../../../static/picture/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>最小订单金额</td>
                <td><input name="money_money" type="text" id="min_goods_amount" value="<?= $v['money_money']?>" size="20">
            ...
            <tr>
                <td class="label">
                    <a href="javascript:showNotice('Send_start_a');" title="点击此处查看提示信息">
                        <img src="../../../static/picture/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>发放起始日期</td>
                <td>
                    <input name="send_start_date" type="datetime-local" id="send_start_date" value="<?= $v['send_start_date']?>" size="12">
            ...
            <tr>
                ...
                <td>
                    <input name="send_end_date" type="datetime-local" value="<?= $v['send_end_date']?>" id="send_end_date" size="12">
                </td>
            </tr>
            <tr>
                <td class="label">
                    <a href="javascript:showNotice('Use_start_a');" title="点击此处查看提示信息">
                        <img src="../../../static/picture/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    使用起始日期</td>
                <td>
                    <input name="use_start_date" type="datetime-local" value="<?= $v['use_start_date']?>" id="use_start_date" size="12">
            ...
            <tr>
                ...
                <td>
                    <input name="use_end_date" type="datetime-local" value="<?= $v['use_end_date']?>" id="use_end_date" size="12"> </td>
            </tr>
            <tr>
                <td class="label">&nbsp;</td>
                <td>
...
<div id="footer">
    共执行 3 个查询，用时 0.135008 秒，Gzip 已禁用，内存占用 1.436 MB<br>
