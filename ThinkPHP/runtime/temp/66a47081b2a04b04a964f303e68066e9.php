<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:98:"C:\Users\Shinelon\Desktop\ecshop\ThinkPHP\public/../application/admin\view\goods\user_profile.html";i:1537261717;}*/ ?>
     ...
     <form name="formEdit" action="user.php" method="post" onSubmit="return userEdit()">
      <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
                ...
                <tr>
                  ...
                  <td width="72%" align="left" bgcolor="#FFFFFF"><input name="email" type="text" value="12234@qq.com" size="25" class="inputBg" /><span style="color:#FF0000"> *</span></td>
                </tr>
						<tr>
			<td width="28%" align="right" bgcolor="#FFFFFF" >QQ：</td>
			<td width="72%" align="left" bgcolor="#FFFFFF">
			<input name="extend_field2" type="text" class="inputBg" value="1297048119"/>			</td>
		</tr>
								<tr>
			<td width="28%" align="right" bgcolor="#FFFFFF" >办公电话：</td>
			<td width="72%" align="left" bgcolor="#FFFFFF">
			<input name="extend_field3" type="text" class="inputBg" value="1515"/>			</td>
		</tr>
								<tr>
			<td width="28%" align="right" bgcolor="#FFFFFF" >家庭电话：</td>
			<td width="72%" align="left" bgcolor="#FFFFFF">
			<input name="extend_field4" type="text" class="inputBg" value="151"/>			</td>
		</tr>
								<tr>
			<td width="28%" align="right" bgcolor="#FFFFFF" id="extend_field5i">手机：</td>
			<td width="72%" align="left" bgcolor="#FFFFFF">
			<input name="extend_field5" type="text" class="inputBg" value="110"/><span style="color:#FF0000"> *</span>			</td>
		</tr>
								<tr>
		...
		<tr>
		  ...
		  <td width="72%" align="left" bgcolor="#FFFFFF">
		  <input name="passwd_answer" type="text" size="25" class="inputBg" maxlengt='20' value="我走过最长的路就是你的套路"/>		  </td>
		</tr>
				                <tr>
