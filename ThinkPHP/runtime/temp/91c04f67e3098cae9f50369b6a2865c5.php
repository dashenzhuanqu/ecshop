<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:101:"C:\Users\Shinelon\Desktop\ecshop\ThinkPHP\public/../application/index\view\quanxi\privilege_edit.html";i:1536626547;}*/ ?>
﻿<!-- $Id: privilege_info.htm 16616 2009-08-27 01:56:35Z liuhui $ -->
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
  <base href="\">
<title>ECSHOP 管理中心 - 编辑管理员 </title>
...
<h1>
    ...
    <span class="action-span1"><a href="index.php?act=main">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1">&nbsp;&nbsp;>&nbsp;&nbsp;编辑管理员 </span>
...
<table width="100%">
  ...
  <tr>
    ...
    <td>
      <input type="text" name="user_name" maxlength="20" value="<?=$v['admin_name']?>" size="34"/><span class="require-field">*</span></td>
  </tr>
  <tr>
    <td class="label">Email地址</td>
    <td>
      <input type="text" name="email" value="<?=$v['admin_email']?>" size="34" /><span class="require-field">*</span></td>
  </tr>
     <tr>
    <td class="label">
      <a href="javascript:showNotice('passwordNotic');" title="点击此处查看提示信息">
        <img src="static/picture/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>旧密码</td>
    <td>
  ...
  <tr>
    ...
    <td colspan="2" align="center">
      ...
      <input type="hidden" name="id" value="<?=$v['admin_id']?>" /></td>
  </tr>      
  <?php }  ?>
</table>
</form>
...
<div id="footer">
共执行 4 个查询，用时 0.021585 秒，Gzip 已禁用，内存占用 1.175 MB<br />
