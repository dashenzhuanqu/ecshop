<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:97:"G:\CodeFile\WWW\month12\perject\ecshop\ThinkPHP\public/../application/index\view\goods\goods.html";i:1537272178;}*/ ?>
<<<<<<< HEAD
=======
...
<head>
    ...
    <script>
        ...
        var goods_price_not_null = "本店售价不能为空。";
        var goods_price_not_number = "本店售价不是数值。";
        var select_please = "请选择...";
        var button_add = "添加";
        var button_del = "删除";
        var spec_value_not_null = "规格不能为空";
        var spec_price_not_number = "加价不是数字";
        var mall_price_not_number = "市场价格不是数字";
...
<!--遮罩-->
<h1>
    <a class="btn btn-right" href="/index/goods/goods">商品列表</a>
...
<!--<script type="text/javascript" src="../../../static/js/utils.js"></script><script type="text/javascript" src="../../../static/js/selectzone.js"></script><script type="text/javascript" src="../../../static/js/colorselector.js"></script><script type="text/javascript" src="../../../static/js/calendar.js"></script>-->
...
<div class="tab-div">
    ...
    <!-- tab body -->
    <div id="tabbody-div">
        <form enctype="multipart/form-data" action="<?php echo url('goods/goods_upd'); ?>" method="post">
            <!-- 鏈€澶ф枃浠堕檺鍒 -->
            ...
            <table width="90%" id="general-table" align="center" class="gk-table">
                <tr>
                    ...
                    <td><input type="text" name="goods_name" value="<?php echo $arr['goods_name']; ?>" style="float:left;color:;" size="30" />
                        <!--<div style="background-color:;float:left;margin-left:2px;" id="font_color" onclick="ColorSelecter.Show(this);"><img src="../../../static/picture/color_selecter.gif" style="margin-top:-1px;" /></div><input type="hidden" id="goods_name_color" name="goods_name_color" value="" />&nbsp;-->
                ...
                <tr>
                    ...
                    <td><input type="text" name="goods_art" value="<?php echo $arr['goods_art']; ?>" size="20" onblur="checkGoodsSn(this.value,'0')" /><span id="goods_sn_notice"></span><br />
              ...
              <!--<input type="text" class="text" size="10" name="addedCategoryName" />-->
               ...
               <button type="button" class="btn btn-def " onclick="hideCatDiv()" title="隐藏"><<</button>
                ...
                <tr>
                    ...
                    <td><select name="b_id" onchange="hideBrandDiv()" >
                        <option value="0">请选择...</option>
              ...
              <!--<input type="text" class="text" size="15" name="addedBrandName" />-->
               ...
               <button type="button" class="btn btn-def " onclick="hideBrandDiv()" title="隐藏"><<</button>
                ...
                <tr>
                    ...
                    <td><input type="text" name="goods_price" value="<?php echo $arr['goods_price']; ?>" size="20" onblur="priceSetted()"/>
                ...
                <tr>
                    ...
                    <td><input type="text" name="mall_price" value="<?php echo $arr['mall_price']; ?>" size="20" />
                ...
                <tr>
                    ...
                    <td id="promote_3"><input type="text" id="promote_1" name="vip_price" value="<?php echo $arr['vip_price']; ?>" size="20" /></td>
                </tr>
                <tr id="promote_4">
                    <td class="label" id="promote_5">促销日期：</td>
                    <td id="promote_6" class="cal-group">
                        <input name="add_time" type="datetime-local" id="promote_start_date" size="12" value="<?php echo $arr['add_time']; ?>"><img src="../../../static/picture/cal.png" alt=""></button> - <input name="end_time" type="datetime-local" id="promote_end_date" size="12" value="<?php echo $arr['end_time']; ?>"/><img src="../../../static/picture/cal.png" alt=""></button>
                    </td>
                </tr>
                <tr>
                    <td class="label">上传商品图片：</td>
                    <td>
                        <input type="file" name="goods_img" value="<?php echo $arr['goods_img']; ?>" size="35" />
                        <img src="../../../static/picture/no.svg" width="16
                        <br />">
                        <input type="text" size="40" value="商品图片外部URL" style="color:#aaa;" name="goods_img"/>
                    </td>
                </tr>
                <!--<tr id="auto_thumb_1">-->
            ...
            <table width="90%" id="mix-table" style="display:none" align="center">
                <tr>
                    ...
                    <td><input type="text" name="goods_weight" value="<?php echo $arr['goods_weight']; ?>" size="20" />
                ...
                <tr>
                    ...
                    <td><input type="text" name="suk" value="<?php echo $arr['suk']; ?>" size="20" /><br />
                ...
                <tr id="alone_sale_1">
                    ...
                    <td id="alone_sale_3"><input type="checkbox" name="is_put" value="1" checked="checked" /> 打勾表示允许销售，否则不允许销售。</td>
                </tr>
                <tr>
                    <td class="label">能作为普通商品销售：</td>
                    <td><input type="checkbox" name="is_shipping" value="1" checked="checked" /> 打勾表示能作为普通商品销售，否则只能作为配件或赠品销售。</td>
                </tr>
                <tr>
                    <td class="label">是否为免运费商品</td>
                    <td><input type="checkbox" name="Is_alone_sale" value="1"  /> 打勾表示此商品不会产生运费花销，否则按照正常运费计算。</td>
                </tr>
                <tr>
                    <td class="label">商品关键词：</td>
                    <td><input type="text" name="keywords" value="<?php echo $arr['keywords']; ?>" size="40" /> 用空格分隔</td>
                </tr>
                <tr>
                    <td class="label">商品简单描述：</td>
                    <td><textarea name="goods_brief" value="<?php echo $arr['goods_brief']; ?>" cols="40" rows="3"></textarea></td>
                </tr>
                <tr>
                    <td class="label">
                    ...
                    <td><textarea name="seller_note" value="<?php echo $arr['seller_note']; ?>" cols="40" rows="3"></textarea><br />
            ...
            <table width="90%" id="linkgoods-table" style="display:none" align="center">
                ...
                <tr>
                    <td colspan="3">
                        ...
                        <select name="cat_id1"><option value="0">所有分类<option value="1" >饮料</option><option value="2" >&nbsp;&nbsp;&nbsp;&nbsp;学习</option></select>
                        <select name="brand_id1"><option value="0">所有品牌<option value="1">可口可乐</option><option value="2">文档</option></select>
            ...
            <table width="90%" id="groupgoods-table" style="display:none" align="center">
                ...
                <tr>
                    <td colspan="3">
                        <img src="../../../static/picture/icon_search.svg" width="26" height="22" border="0" alt="SEARCH" />
                        <select name="cat_id2"><option value="0">所有分类<option value="1" >饮料</option><option value="2" >&nbsp;&nbsp;&nbsp;&nbsp;学习</option></select>
                        <select name="brand_id2"><option value="0">所有品牌<option value="1">可口可乐</option><option value="2">文档</option></select>
...
<!--<script language="JavaScript">-->
    ...
    <!--{-->
        ...
        <!--validator.required('goods_price', goods_price_not_null);-->
        <!--validator.isNumber('goods_price', goods_price_not_number, true);-->
        <!--validator.isNumber('mall_price', mall_price_not_number, false);-->
    ...
    <!--/**-->
     ...
     <!--* @param   string  priceName   浠锋牸杈撳叆妗嗗悕绉帮紙濡傛灉娌℃湁锛屽彇goods_price锛-->
     <!--*/-->
    <!--function computePrice(inputName, rate, priceName)-->
    <!--{-->
        <!--var shopPrice = priceName == undefined ? document.forms['theForm'].elements['goods_price'].value : document.forms['theForm'].elements[priceName].value;-->
    ...
    <!--{-->
        <!--computePrice('goods_price', marketPriceRate);-->
    ...
    <!--{-->
        <!--var goods_price = parseFloat(document.forms['theForm'].elements['goods_price'].value);-->

        <!--var rank = new Array();-->

        <!--rank[1] = 100;-->

        <!--if (goods_price >0 && rank[rank_id] && document.getElementById('rank_' + rank_id) && parseInt(document.getElementById('rank_' + rank_id).value) == -1)-->
        <!--{-->
            <!--var price = parseInt(goods_price * rank[rank_id] + 0.5) / 100;-->
    ...
    <!--{-->
        <!--computePrice('goods_price', 1/marketPriceRate, 'mall_price');-->
        <!--computePrice('integral', integralPercent / 100);-->
    ...
    <!--{-->
        <!--document.forms['theForm'].elements['mall_price'].value = parseInt(document.forms['theForm'].elements['mall_price'].value);-->
    <!--}-->
...
<!--</script>-->
<div id="footer">
    共执行 10 个查询，用时 0.026997 秒，Gzip 已禁用，内存占用 2.119 MB<br />
